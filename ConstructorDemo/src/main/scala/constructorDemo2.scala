...
class demoClass12(val a:Int = 99, val b:Double = 88.88, val c:String = "Hello Scala"){
  val x = a
  var y = b
  val z = c
...
object constructorDemo2 {
  def main(args: Array[String]): Unit = {
    val demoObject1 = new demoClass12(5,7.2,"Hello World!")
    val demoObject2 = new demoClass12()
    val demoObject3 = new demoClass12(25)
//    val demoObject4 = new demoClass2("Hello") - You need to pass parameter in correct sequence, for out of sequence see next example
    val demoObject5 = new demoClass12(c = "Hello")
    val demoObject6 = new demoClass12(c = "Hello", a = 5, b = 6.6)
    ...
    val demoObject9 = new demoClass12( a=5,b=5.5 , "hello")
  }
}